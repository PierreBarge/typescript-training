describe("class", () => {
  ...
  it("can have static methods and properties", () => {
    ...
    class Musician {
      ...
      private constructor(instrument?: string) {
        this.instrument = instrument;
      }
      static create(instrument?: string) {
        const newMusician = new Musician(instrument);
        this.instances.push(newMusician);
        return newMusician;
      }
    }
  ...
  it("can use property setters and getters", () => {
    ...
    class Musician {
      ...
      constructor(instrument?: string) {
        this.instrument = instrument;
        this.description = "this musician plays " + instrument;
      }
    }
  ...
  it("can use property setters and getters", () => {
    ...
    expect(musician.allBands).toBe(
      "this musician played in ABBA, Rolling Stones"
    );
    musician.band = "Iron Maiden";
    expect(musician.allBands).toBe(
      "this musician played in ABBA, Rolling Stones, Iron Maiden"
    );
  });
});
